...
export const id = {
  ...
  review: {
    ...
    addNote:
      'Review yang Anda tulis di sini masuk ke antrean seperti review lain — dikelompokkan tema, didraftkan balasan, tunduk pada aturan yang sama. Bedanya satu: ia ditandai demo, karena bukan dari Google.',
    ...
    addClose: 'Tutup',
    addReceipt: 'Review {id} masuk ke antrean. Draft balasannya sudah dibuat.',
