...
export const id = {
  ...
  admin: {
    ...
    modelApiRuntime: 'Runtime API',
    modelSessions: 'Sesi & jejak',
    modelSearchIndex: 'Indeks terkelola',
    modelManagedRuntime: 'Runtime terkelola',
    pathDeterministic: 'Jalur deterministik',
    retrievalKeyword: 'Skoring kata kunci · packages/core',
    runtimeSupervisor: 'Supervisor · packages/core',
    runtimeLocal: 'Node lokal',
    sessionsInMemory: 'Di memori proses',
